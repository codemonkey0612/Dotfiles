...
pacman_packages=(
    ...
    # Misc
    noto-fonts ttf-jetbrains-mono-nerd nwg-look adw-gtk-theme kvantum-qt5 libvips cliphist gnome-characters keepass
)
...
aur_packages=(
    ...
    # Misc
    ttf-segoe-ui-variable sddm-sugar-candy-git apple_cursor whitesur-icon-theme tint
)
